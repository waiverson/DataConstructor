...
from ..utils.distribution import choice_distribution
...
class BaseProvider(object):
    ...
    @classmethod
    def random_str(cls, num_len=11, char_len=7):
        """
        this function is add by xyc
        :param length: return random str length
        ...
        for i in range(num_len):
            num_str += nums[random.randint(0, len(nums)-1)]
        if char_len > 0:
